...
class Hummerscaled(GroundRobot):
    ...
    def __init__(self, name = None, debug = True):
        ...
        GroundRobot.__init__(self, 'test/robots/HummerScaled.blend', name)
        self.properties(classpath = "test.robots.HummerScaled.Hummerscaled",brakes = 0.0, friction = 200.0, force = 0.0,
